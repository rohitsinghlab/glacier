...
def execute_cmdline():
	...
	parser.add_argument('-ls','--lam_start',dest='lam_start',type=float,default=-3)
...
#check for nans
	...
	ray.init(object_store_memory=10**9, num_cpus=16)
	...
	resources_per_trial = {"cpu":16 , "gpu": 1, "memory": 16 * 1024 * 1024 * 1024}
